...
module.exports = {
  registerEvents: function (webView, viewInstanceId) {
    ...
    ipcRenderer.on(`ELECTRON_GUEST_VIEW_INTERNAL_VISIBILITY_CHANGE-${viewInstanceId}`, function (event, visibilityState) {
      webView.onVisibilityChanged(visibilityState)
    })
  },
  deregisterEvents: function (viewInstanceId) {
    ...
    ipcRenderer.removeAllListeners(`ELECTRON_GUEST_VIEW_INTERNAL_VISIBILITY_CHANGE-${viewInstanceId}`)
  },
